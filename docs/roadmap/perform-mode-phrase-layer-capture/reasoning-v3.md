...
- Perform is represented as the phrase write mode, not a destination. Capture and Discard live in the phrase header because they operate on the live phrase copy, so the top transport area should not carry separate Perform or Capture commands.
