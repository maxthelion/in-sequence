...
**Status:** ✅ Completed 2026-04-21. Tag `v0.0.19-remove-song-view`. Verified with xcodegen regenerate, build, and full test suite.
...
- [x] **Step 1: Verify nothing else imports SongWorkspaceView**
...
- [x] **Step 2: Delete the file and the empty directory**
...
- [x] **Step 3: Regenerate the xcodeproj to drop the file from the project**
...
- [x] **Step 4: Build (will fail — `WorkspaceDetailView.swift:23-24` still references the deleted type)**
...
- [x] **Step 1: Remove the `.song` case and its branches**
...
- [x] **Step 2: Build (still fails at `WorkspaceDetailView.swift` + `SidebarView.swift`)**
...
- [x] **Step 1: Locate and remove the Song dispatch case**
...
- [x] **Step 2: Build (still fails at `SidebarView.swift`)**
...
- [x] **Step 1: Remove the Song arrangement row**
...
- [x] **Step 3: Full test suite passes**
...
- [x] **Step 4: Commit (single commit for the whole removal)**
...
- [x] **Step 1: Open the app and verify**
...
- [x] **Step 3: Log a note to sweep `wiki/pages/project-layout.md:135`**
