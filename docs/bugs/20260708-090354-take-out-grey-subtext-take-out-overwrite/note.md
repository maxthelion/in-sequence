Take out grey subtext. Take out overwrite. Make the apply button match style. Note the implementation of incorrect apply button and look for other instances. render a tiny version of the pattern in each pill using the same mechanism in the history viewer.

Screenshots:
- 38-drum-kit-matrix-template-chooser.png
