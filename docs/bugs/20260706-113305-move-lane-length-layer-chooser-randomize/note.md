move lane, length, layer chooser, randomize and config into the header for the clip. Take out the noise - clip pill, mono 8 pattern 4, grey sub text.

Screenshots:
- 18-track-detail-steps-clip.png
