...
10a-phrase-layer-automation-modal|workspace=phrase,phraseWorkspaceTab=layers,phraseMatrixSelectedLayerID=pattern,phraseAutomationModalVisible=true,phraseAutomationModalMode=perBar|phraseMatrixTrackCount=8;phraseMatrixPhraseCount=8;phraseWorkspaceTab=layers;phraseMatrixLayerID=pattern;phraseLayerSelect=2;phraseAutomationFixture=bars;phraseLayerAutomation=open;transport=stop
10aa-phrase-layer-automation-points|workspace=phrase,phraseWorkspaceTab=layers,phraseAutomationModalVisible=true,phraseAutomationModalMode=points|phraseMatrixTrackCount=8;phraseMatrixPhraseCount=8;phraseMatrixEnsureDefaultLayers=true;phraseWorkspaceTab=layers;phraseLayerAutomationTarget=intensity;phraseAutomationFixture=points;transport=stop
# The former density rows are retired: density is no longer a phrase perform
# layer exposed by the current matrix surface. Their command wrote density data
# while the visible layer stayed pattern, producing misleading duplicates.
