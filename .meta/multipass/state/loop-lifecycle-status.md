...
- generated: 2026-07-06T13:15:41.240Z
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | --- |
| `build/au-discovery-rescan` | build | complete | `feature/au-discovery-rescan` | diverged | missing | 0 | 0 | 7 | none |
| `build/au-runtime-safety` | build | active | `feature/au-runtime-safety` | diverged | dirty | 0 | 0 | 2 | active-loop-has-blocked-work |
...
| `build/drum-kit-matrix-sound-prep` | build | active | `feature/drum-kit-matrix-sound-prep` | yes | clean | 1 | 0 | 0 | active-build-branch-contained-in-main |
...
| `build/mixer-strip-followup` | build | complete | `feature/mixer-strip-followup` | yes | dirty | 0 | 0 | 3 | none |
| `build/note-repeat` | build | complete | `auto/roadmap-15-note-repeat` | yes | missing | 0 | 0 | 12 | none |
| `build/observability-log-issues` | build | locked | `auto/roadmap-21-observability-log-issues` | diverged | missing | 0 | 0 | 20 | active-loop-has-blocked-work |
| `build/perform-mode-phrase-layer-capture` | build | complete | `auto/roadmap-perform-mode-phrase-layer-capture` | yes | missing | 0 | 0 | 0 | none |
...
| `build/routing-source-mixer-split` | build | complete | `feature/routing-source-mixer-split` | diverged | missing | 0 | 0 | 7 | none |
| `build/scene-perform` | build | complete | `auto/roadmap-2-scene-perform` | yes | missing | 0 | 0 | 1 | none |
...
| `build/track-phrase-perform-mini-cells` | build | complete | `feature/track-phrase-perform-mini-cells` | yes | dirty | 0 | 1 | 1 | terminal-loop-has-open-messages |
...
| `pm/drum-kit-matrix-sound-prep` | pm | active |  | n/a | n/a | 1 | 0 | 0 | active-pm-feature-build-started |
...
| `pm/july-4-phrase-layers-global-apply` | pm | active |  | n/a | n/a | 0 | 1 | 0 | none |
...
| `pm/track-phrase-perform-interaction-prep` | pm | active |  | n/a | n/a | 1 | 0 | 0 | none |
| `project` | project | active |  | n/a | n/a | 6 | 1 | 133 | active-loop-has-blocked-work |
